...
c
c controla o calculo das medidas (a) e (f) para vizinhanças de 1 até 
...
c      use portlib
      ...
      character*100 saida7,saida8,saida9,saida11,saida12,saida13
...
c      write(*,*)'tinic=',tempo1
      open (unit=3,file='madchar13.dat')
...
c        de adjacencia, seja lista
      ...
      read (3,500)entrada
      read (3,500)saida7,saida8,saida9,saida11,saida12,saida13
...
c chama rotina assorta: grau de assortatividadeda rk matriz mad(ip)
       ...
       enddo
c==============================================================================
c transfere cm para am para fins de impressão de resultados
...
c escreve a matriz de vizinhança da rede em saida11 
     ...
     . '  diametro = ',npp
       ...
       do i = 1,nm
        write(11,fmt='(1000I2)')(am(i,j),j=1,nm)
       enddo
